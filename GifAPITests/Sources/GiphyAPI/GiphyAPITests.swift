...
final class GiphyAPITests: XCTestCase {
    ...
    func test_getRandomGIF_whenRequestSucceeds_thenShouldDecodeObject() {
        ...
        let expectedGif = Gif(id: "jniKOKepMY8KotuZMx", title: "klever GIF by Alberi Creativos",
                              ...
                              stillImageURL: "https://media3.giphy.com/media/jniKOKepMY8KotuZMx/200w_s.gif?cid=e1bb72fff7b18f5e32767bc1ff5146fa45f14898a1b59ffc&rid=200w_s.gif",
                              fixedWidthVideoURL: "https://media3.giphy.com/media/jniKOKepMY8KotuZMx/200w.mp4?cid=e1bb72fff7b18f5e32767bc1ff5146fa45f14898a1b59ffc&rid=200w.mp4",
    ...
    func test_searchForGIF_whenRequestSucceeds_thenShouldDecodeObject() {
        ...
        let expectedGif = Gif(id: "JRlqKEzTDKci5JPcaL", title: "",
                              ...
                              stillImageURL: "https://media3.giphy.com/media/JRlqKEzTDKci5JPcaL/200w_s.gif?cid=e1bb72ffc913ff0cacf52046c2dbe311f3bf986661a800db&rid=200w_s.gif",
                              fixedWidthVideoURL: "https://media3.giphy.com/media/JRlqKEzTDKci5JPcaL/200w.mp4?cid=e1bb72ffc913ff0cacf52046c2dbe311f3bf986661a800db&rid=200w.mp4",
